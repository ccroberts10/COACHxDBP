...
async function sendWelcomeEmail(email, userName, tier = null) {
  ...
  if (tier === 'free') {
    ...
    body = `<h1 style="font-size:24px;color:#000;margin:0 0 12px;letter-spacing:-0.02em;">Welcome to DBP${userName ? ', ' + userName : ''}</h1>
     ...
     <p style="color:#444;font-size:15px;line-height:1.5;margin-top:14px;">Want more? Upgrade anytime to <strong>Rewards</strong> ($19/mo) for a free Sunday recovery drink, 10% off retail, free flat repairs, and more — or <strong>Coach</strong> ($39/mo) for AI training plus all rewards.</p>
