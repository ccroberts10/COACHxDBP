...
async function sendWelcomeEmail(email, userName, tier = null) {
  ...
  if (tier === 'free') {
    ...
    body = `<h1 style="font-size:24px;color:#000;margin:0 0 12px;letter-spacing:-0.02em;">Welcome to DBP${userName ? ', ' + userName : ''}</h1>
     ...
     <p style="color:#444;font-size:15px;line-height:1.5;margin-top:14px;">Want more? Upgrade anytime to <strong>Rewards</strong> ($19/mo) for free Sunday coffee, 10% off retail, free flat repairs, and more — or <strong>Coach</strong> ($39/mo) for AI training plus all rewards.</p>
    ...
    body = `<h1 style="font-size:24px;color:#000;margin:0 0 12px;letter-spacing:-0.02em;">Welcome to DBP Rewards${userName ? ', ' + userName : ''}</h1>
     <p style="color:#444;font-size:15px;line-height:1.5;">Your DBP Rewards membership is active. Show your member code at the shop to start earning. Free Sunday coffee, 10% off retail, free flat repairs, and an annual tune-up are yours.</p>
    ...
    body = `<h1 style="font-size:24px;color:#000;margin:0 0 12px;letter-spacing:-0.02em;">Welcome to DBP Coach${userName ? ', ' + userName : ''}</h1>
     ...
     <p style="color:#444;font-size:15px;line-height:1.5;margin-top:14px;">Plus all the DBP Rewards perks: free Sunday coffee, 10% off retail, free flat repairs, annual tune-up.</p>
